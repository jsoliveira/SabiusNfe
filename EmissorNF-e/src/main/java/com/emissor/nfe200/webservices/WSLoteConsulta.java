...
import com.emissor.nfe200.classes.lote.consulta.NFLoteConsulta;
...
import com.emissor.nfe200.webservices.lote.consulta.NfeRetRecepcao2Stub;
import com.emissor.nfe200.webservices.lote.consulta.NfeRetRecepcao2Stub.NfeRetRecepcao2Result;
...
class WSLoteConsulta {
    ...
    private OMElement efetuaConsulta(final OMElement omElement) throws AxisFault, RemoteException, IOException {
