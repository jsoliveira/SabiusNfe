...
import com.emissor.nfe200.assinatura.AssinaturaDigital;
import com.emissor.nfe200.classes.NFAutorizador;
import com.emissor.nfe200.classes.lote.envio.NFLoteEnvio;
import com.emissor.nfe200.classes.lote.envio.NFLoteEnvioRetorno;
import com.emissor.nfe200.transformers.NFRegistryMatcher;
import com.emissor.nfe200.webservices.gerado.NfeRecepcao2Stub;
import com.emissor.nfe200.webservices.gerado.NfeRecepcao2Stub.NfeCabecMsg;
import com.emissor.nfe200.webservices.gerado.NfeRecepcao2Stub.NfeCabecMsgE;
import com.emissor.nfe200.webservices.gerado.NfeRecepcao2Stub.NfeDadosMsg;
import com.emissor.nfe200.webservices.gerado.NfeRecepcao2Stub.NfeRecepcaoLote2Result;
...
class WSLoteEnvio {
    ...
    private NfeCabecMsgE getCabecalhoSOAP() throws IOException {
